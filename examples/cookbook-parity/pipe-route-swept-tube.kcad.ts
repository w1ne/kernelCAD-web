// Pipe route through 3D waypoints with a bend radius at each corner, swept tube profile.
//
// Run with:
//   npx tsx src/agent/cli/index.ts evaluate examples/cookbook-parity/pipe-route-swept-tube.kcad.ts
//
