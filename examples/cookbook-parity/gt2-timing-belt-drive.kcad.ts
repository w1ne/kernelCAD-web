// GT2 timing-belt drive: two pulleys at a center distance. Belt length from pitch
// diameters and center distance, rounded to a real GT2 tooth count (2 mm pitch).
//
// Run with:
//   npx tsx src/agent/cli/index.ts evaluate examples/cookbook-parity/gt2-timing-belt-drive.kcad.ts
//
