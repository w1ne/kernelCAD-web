...
- Freeform NURBS surfaces, NURBS curves, or multi-section sweeps (`nurbsSurface`, `surfaceFromCurves`, `nurbsCurve`, `spline3d`, `variableSweep`) → also load `kernelcad-nurbs`.
