...
export const NEXT_ACTIONS: Record<DiagnosticCode, NextAction> = {
  ...
  'feature.curve3d.degenerate-controls':          { kind: 'fix-arg', field: 'controlPoints' },
  'feature.curve3d.weights-length-mismatch':      { kind: 'fix-arg', field: 'weights' },
  'feature.curve3d.weights-non-positive':         { kind: 'fix-arg', field: 'weights' },
  'feature.curve3d.knots-length-mismatch':        { kind: 'fix-arg', field: 'knots' },
  'feature.curve3d.closed-endpoints-mismatch':    { kind: 'fix-arg', field: 'controlPoints' },
  'feature.variable-sweep.sections-out-of-order': { kind: 'fix-arg', field: 'sections' },
  'feature.variable-sweep.sections-not-spanning': { kind: 'fix-arg', field: 'sections' },
  'feature.variable-sweep.spine-too-short':       { kind: 'fix-arg', field: 'spine' },
