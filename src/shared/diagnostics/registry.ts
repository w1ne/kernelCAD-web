...
export const DIAGNOSTIC_REGISTRY = {
  ...
  'assembly.mate.not-physically-realized': {
    hintTemplate:
      "Use joint.clevis(...) (or the pattern equivalent for prismatic/cylindrical) to ensure a real pin or shaft constrains both parts and the through-hole is aligned through the bearing geometry. See kernelcad-kinematic SKILL.md \"Mechanism delivery\".",
