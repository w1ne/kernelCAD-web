...
// Knot helpers live in the `nurbsKnots` leaf so `pathNurbsLowerer` (and the
// verb bridge) can share them without importing this surface lowerer back.
export { clampedUniformKnots, decomposeKnots };
