...
export function PlaneSelectorPanel() {
    const { setSketchMode, startFaceSelection } = useWorkbench();
    ...
    const handleSelect = (plane: SketchPlane) => {
        setSketchMode({ active: true, plane, currentSketch: null, tool: 'line' });
        closePanel('planeSelector');
    };
    ...
    return (
        <div className="flex flex-col gap-3">
            ...
            <div className="mt-2 flex justify-end">
                <button
                    onClick={() => closePanel('planeSelector')}
