...
interface RevolvePanelProps {
    sketchName?: string;
    onConfirm: (params: { sketchName: string; angle: number; axis: string }) => void;
    onCancel: () => void;
}

export function RevolvePanel({ sketchName: initialSketchName, onConfirm, onCancel }: RevolvePanelProps) {
    ...
    return (
        <FloatingPanel title="Revolve" onClose={onCancel}>
