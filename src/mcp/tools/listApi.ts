...
export const GLOBALS: ApiEntry[] = [
  ...
  { name: 'robotArmKit', signature: '(intent?) => RobotArmKitDesign', description: 'Intent-level desktop 3-axis robot arm kit generator. Normalizes link lengths, plate thickness, screw pattern, pivot diameter, and joint limits; exposes `.part(name)`, `.parts()`, `.manifest()`, `.validations()`, `.exportPackage()`, and `.model()` over generated assembly geometry.' },
