...
export function Header() {
    ...
    const viewModeCluster = <ViewModeCluster viewMode3D={viewMode3D} setViewMode3D={setViewMode3D} />;
    ...
    const gridButton = <GridButton gridVisible={gridVisible} setGridVisible={setGridVisible} />;
    const undoRedoButtons = <UndoRedoButtons commandManager={commandManager} />;
                ...
                {narrow && (
                    <OverflowMenu label="View and file controls" testId="header-overflow">
                        ...
                        <MenuRow label="Export">
                            <ExportButtons withLabels isComputing={isComputing} onExport={handleExport} />
                        </MenuRow>
                    </OverflowMenu>
                )}
                {!narrow && (
                    <>
                        ...
                        {historyControl}
                        <div className="h-6 w-px bg-[#333] mx-2" />
                        <ExportButtons withLabels={false} isComputing={isComputing} onExport={handleExport} />
                    </>
                )}
