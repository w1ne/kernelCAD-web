...
function PlaneHotspots({ onNavigate }: ViewGizmoProps) {
    return (
...
function AxisHotspots({ onNavigate }: ViewGizmoProps) {
    return (
        <>
            <Hotspot
...
export function ViewGizmo({ onNavigate }: ViewGizmoProps) {
    return (
        ...
        >
            ...
            <PlaneHotspots onNavigate={onNavigate} />

            <AxisHotspots onNavigate={onNavigate} />
        </div>
    );
}
