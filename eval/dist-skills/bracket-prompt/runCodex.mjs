// eval/dist-skills/bracket-prompt/runCodex.mjs
import { spawnSync } from 'node:child_process';
import { existsSync, readFileSync } from 'node:fs';

const prompt = readFileSync(new URL('./prompt.md', import.meta.url), 'utf8');
const r = spawnSync('codex', ['--prompt', prompt], {
  stdio: 'inherit',
  timeout: 25 * 60 * 1000,
});
if (r.status !== 0) {
  console.error('codex exited non-zero');
  process.exit(1);
}
...
console.log('OK: codex shipped a valid STEP.');
