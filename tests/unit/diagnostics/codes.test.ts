...
describe('diagnostic catalogue invariants', () => {
  it('emits exactly 283 codes', () => {
    ...
    //   dfm.fdm.bed-contact-low, dfm.fdm.tip-risk, dfm.fdm.exceeds-bed = 283.
    expect(DIAGNOSTIC_CODES).toHaveLength(283);
    expect(new Set(DIAGNOSTIC_CODES).size).toBe(283);
  });
