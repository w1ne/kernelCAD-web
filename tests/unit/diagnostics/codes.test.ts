...
describe('diagnostic catalogue invariants', () => {
  it('emits exactly 235 codes', () => {
    ...
    //   diagnostic instead of a silent console.warn). = 235.
    expect(DIAGNOSTIC_CODES).toHaveLength(235);
    expect(new Set(DIAGNOSTIC_CODES).size).toBe(235);
  });
