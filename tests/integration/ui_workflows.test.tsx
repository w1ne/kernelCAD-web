...
import * as GeometryEngine from '../../src/shared/worker/geometryEngine';
import { initFeatures } from '../../src/modeling/features/init';
import type { EditorLike } from '../../src/shared/types/editor';
...
vi.mock('../../src/studio/components/Viewer', () => ({
    default: () => <div data-testid="viewer-mock" />,
}));

vi.mock('../../src/shared/worker/geometryEngine', () => ({
...
vi.mock('../../src/studio/components/Editor', () => ({
