...
import { WorkbenchProvider } from '../../src/studio/context/WorkbenchContext';
import { useWorkbench } from '../../src/studio/context/WorkbenchContext';
import SceneBrowser from '../../src/studio/components/SceneBrowser';
import { GeometryEngine } from '../../src/shared/worker/geometryEngine';

// Mock GeometryEngine
vi.mock('../../src/shared/worker/geometryEngine', async (importOriginal) => {
