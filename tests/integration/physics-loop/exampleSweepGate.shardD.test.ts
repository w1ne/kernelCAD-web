// Physics-loop example-sweep gate — LIVE per-example partition D (shard 3 of SHARD_COUNT).
//
...
// loop check for the index-3-mod-SHARD_COUNT slice of the live-sweep
...
describe('example-sweep gate partition D (live runValidateCli, shard 3)', () => {
