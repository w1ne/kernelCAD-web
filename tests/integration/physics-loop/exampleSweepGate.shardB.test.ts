// Physics-loop example-sweep gate — LIVE per-example partition B (shard 1 of SHARD_COUNT).
//
...
// loop check for the index-1-mod-SHARD_COUNT slice of the live-sweep
...
describe('example-sweep gate partition B (live runValidateCli, shard 1)', () => {
